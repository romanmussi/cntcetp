...
?>
  <div id="cuerpo1" class="grid_9">
	...
	<tbody>
		...
		<tr>
			<td>Operador de demoliciones con herramientas manuales</td>
			<td>Operador de demoliciones con herramientas manuales</td>
		</tr>
		<tr>
			<td>Montador de Zinguería de Obra</td>
			<td>Montador de Zinguería de Obra</td>
		</tr>
		<tr>
			<td>Cementista</td>
		...
		<tr>
			<td>Contratista Techista </td>
			<td>Contratista Techista </td>
		</tr>
		<tr>
			<td>Contratista de Albañilería </td>
			<td>Contratista de Albañilería </td>
		</tr>
		<tr>
		...
		<tr>
			<td>Armador y montador de componentes de madera livianos</td>
			<td>Armador y montador de componentes de madera livianos</td>
		</tr>
		<tr>
			<td>Armador y montador de paneles portantes livianos</td>
			<td>Armador y montador de paneles portantes livianos</td>
		</tr>
		<tr>
			<td>Contratista de construcciones en seco livianas</td>
			<td>Contratista de construcciones en seco livianas</td>
		</tr>
		<tr>
		...
		<tr>
			<td>Contratista de Terminaciones</td>
			<td>Contratista de Terminaciones</td>
		</tr>
		<tr>
		...
		<tr>
			<td>Montador de redes de gas</td>
		...
		<tr>
			<td>Sanitarista Domiciliario</td>
			<td>Sanitarista Domiciliario</td>
		</tr>
		<tr>
		...
		<tr>
			<td>Montador electricista de planta</td>
			<td>Instalador Eléctrico de Planta</td>
		</tr>
		<tr>
			<td rowspan="10">Movimiento de suelos y cargas</td>
			<td>Operador de excavadora</td>
			<td>Operador de excavadora</td>
		</tr>
		<tr>
			<td>Operador de retropala (retrocargadora/retroexcavadora)</td>
			<td>Operador de retropala (retrocargadora/retroexcavadora)</td>
		</tr>
		<tr>
			<td>Operador de cargadora </td>
			<td>Operador de cargadora </td>
		</tr>
		<tr>
			<td>Operador de Mini-cargadora</td>
			<td>Operador de Mini-cargadora</td>
		</tr>
		<tr>
			<td>Operador de compactadora</td>
			<td>Operador de compactadora</td>
		</tr>
		<tr>
		...
		<tr>
			<td>Operador de topadora</td>
			<td>Operador de topadora</td>
		</tr>
		<tr>
			<td>Auxiliar laboratorista de suelos</td>
			<td>Auxiliar laboratorista de suelos</td>
		</tr>
		<tr>
			<td>Auxiliar laboratorista de asfaltos y hormigones</td>
			<td>Auxiliar laboratorista de asfaltos y hormigones</td>
		</tr>
		<tr>
			<td>Auxiliar topográfico</td>
			<td>Auxiliar topográfico</td>
		</tr>
		<tr>
			<td>Figuras a validar y/o a  definir con otros Foros Sectoriales</td>
			<td>Soldador de obra</td>
			<td>Soldador por arco de la industria de la construcción</td>
		</tr>
	</tbody>
</table>
...
<br />
        ...
        <h3>Informes</h3>
            <ul>
                <li><?php echo $html->link('Informe sectorial', '/files/pdfs/info_sectorial/construcciones-informe-sectorial.pdf') ?></li>
            </ul>
        <br />
