...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>Técnico en Equipos e Instalaciones Electromecánicas</td>
			<td></td>
		</tr>
		<tr>
		...
		<tr>
			<td>Montador Tablerista de Sistemas de Comando</td>
			<td>Montador Electricista de Sistemas de Comando</td>
			<td></td>
		</tr>
		<tr>
		...
		<tr>
			<td>Montador de artefactos de iluminación</td>
			<td>Montador de artefactos de iluminación</td>
			<td></td>
		</tr>
	</tbody>
...
<!--<p>
	<ol>
     ...
     <br />
        ...
        <h3>Informes</h3>
            <ul>
                <li><?php echo $html->link('Informe sectorial', '/files/pdfs/info_sectorial/energia-electrica-informe-sectorial.pdf') ?></li>
            </ul>
        <br />
