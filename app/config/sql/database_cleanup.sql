...
INSERT INTO claseinstits
  SELECT id, name
  FROM dblink('rfietp', 'SELECT id, name FROM claseinstits')
  AS t(id integer, name character varying(60));

INSERT INTO dependencias
  SELECT id, name
  FROM dblink('rfietp', 'SELECT id, name FROM dependencias')
  AS t(id integer, name character varying(40));

INSERT INTO etp_estados
  SELECT id, name
  FROM dblink('rfietp', 'SELECT id, name FROM etp_estados')
  AS t(id integer, name character varying(60))
  WHERE id = 2;

INSERT INTO gestiones
  SELECT id, name
  FROM dblink('rfietp', 'SELECT id, name FROM gestiones')
  AS t(id integer, name character varying(20));

/* sin ofertas No Técnicas */
INSERT INTO ofertas
  SELECT id, abrev, name, orden
  FROM dblink('rfietp', 'SELECT id, abrev, name, "order" FROM ofertas
...
INSERT INTO orientaciones
  SELECT id, name
  FROM dblink('rfietp', 'SELECT id, name FROM orientaciones')
...
INSERT INTO jurisdicciones
  SELECT id, name
  FROM dblink('rfietp', 'SELECT id, name FROM jurisdicciones ')
  AS t(id integer, name character varying(40));

INSERT INTO departamentos
  SELECT id, jurisdiccion_id, name
  FROM dblink('rfietp', 'SELECT id, jurisdiccion_id, name FROM departamentos ')
  AS t(id integer, jurisdiccion_id integer, name character varying(64));

INSERT INTO localidades
  SELECT id, departamento_id, name
  FROM dblink('rfietp', 'SELECT id, departamento_id, name FROM localidades ')
  AS t(id integer, departamento_id integer, name character varying(64));

INSERT INTO tipoinstits
  SELECT id, jurisdiccion_id, name
  FROM dblink('rfietp', 'SELECT id, jurisdiccion_id, name FROM tipoinstits ')
